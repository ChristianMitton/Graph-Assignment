...
class Friend {
	int fnum; //index of friend in members array 
	Friend next;
...
public class Graph {
	...
	// stores the index position of student in memebers
	//so if you do map.get("ming", you'll get his position in the members array)
